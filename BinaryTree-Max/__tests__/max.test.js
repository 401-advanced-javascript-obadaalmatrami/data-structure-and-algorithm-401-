...
const  BinaryTree = require('../src/max-binarytree-vlaue.js');
...
describe('Binary tree', () => {
  ...
  it('it should successfully find the maximum value', () => {
    const tree = new BinaryTree();
    ...
    expect(tree.maximumValue(tree)).toEqual(12);
    console.log('the maximum value = ', tree.maximumValue(tree));
  });
